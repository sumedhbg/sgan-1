...
#SET OF CODES FOR LOADING THE DATASET
...
#CODE FOR GENERATOR LOSS
def custom_generator_loss(y_true, y_pred):
    # Calculate binary cross entropy loss
    return K.binary_crossentropy(y_true, y_pred)
    
#CODE TO SAVE IMAGES AFTER EVERY TWO EPOCHS AND SAVING THE LOGS
...
# WRITING THE MAIN FUNCTION TO INITIALIZE HYPER-PARAMETERS AND TRAIN OUR STAGE 1 GAN
